...
async function getVersion(variant: Variant): Promise<string> {
...
export async function packageDeb(version?: string, variant: Variant = V1): Promise<string> {
...
export async function packagePacman(version?: string, variant: Variant = V1): Promise<string | undefined> {
  const ver = version ?? await getVersion(variant);
